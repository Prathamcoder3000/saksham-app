  ...
  Future<void> triggerSOS() async {
    ...
    try {
        ...
        if (response.statusCode == 201) {
            ...
            if (mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Failed to send SOS. Please call admin directly.')));
        }
    } catch (e) {
        if (mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Network error. Failed to send SOS alert.')));
    } finally {
