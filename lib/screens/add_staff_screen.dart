      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 0,
            child: ClipRRect(
              borderRadius: BorderRadius.zero, // ✅ ADD THIS
              ...
              child: Column(
                ...
                children: [
                  ...
                  _card(
                    ...
                    child: Column(
                      children: [
                        _input("Full Name", "e.g. Rahul Sharma"),
                  ...
                  _card(
                    ...
                    child: Column(
                      children: [
                        _phone(),
                        const SizedBox(height: 15),
                        _input("Email Address", "rahul@saksham.care"),
                      ],
                    ),
                  ),
    ...
    children: [
      ...
      Container(
        ...
        child: DropdownButton(
          ...
          underline: SizedBox(),
          items: [
            DropdownMenuItem(value: "1", child: Text("Select Role")),
          ],
          onChanged: null,
        ),
      ),
